...
import data.obs.micromaps.arrow_functions as afc
...
from data.utils import load_lotss_catalog, parse_dset_path
...
from data.obs.micromaps.monitoring import monitor
...
def make_encodings_dset(
    ...
    maps_dset_path = parse_dset_path(dset, lookup=paths.MICROMAP_SUBSETS_ARROW)
