...
cd /hs/fs08/data/group-brueggen/sandhya/MASSIMOnew
...
singularity exec --pid --writable-tmpfs --containall --cleanenv --no-home\
 --bind /hs/fs08/data/group-brueggen/sandhya/MASSIMOnew:/MASSIMOnew\
 --workdir /hs/fs08/data/group-brueggen/sandhya/MASSIMOnew\
