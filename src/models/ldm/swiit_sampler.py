...
from models.ldm.swiit_sampler_config import SWIITSamplerConfig
...
class SWIITSampler:
        ...
        return {
            ...
            "ext_context": (
                torch.zeros(
                    ...
                    batch_size,
                    ctxt_channels,
                    self.config.ext_context_size,
                    self.config.ext_context_size,
                )
                if self.config.f_extended_ctxt > 1
                else None
            ),
    ...
    def _make_extended_ctxt(
        ...
        # map.
        padding_width = (self.config.ext_context_size - self.config.latent_size) // 2
