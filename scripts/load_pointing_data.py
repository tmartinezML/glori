...
out_parent = Path("/hs/babbage/data/group-brueggen/tmartinez/pointings")
...
def check_file_online(pointing: str) -> bool:
    ...
    try:
        response = requests.head(make_link(pointing), verify=False, timeout=5)
