...
# ---------------- CONFIG ----------------
REMOTE = "bbd0953@hopper"
REMOTE_DIR = "/storage/tmartinez/image_data/LOFAR/micromaps-arrow/micromap_encodings-DR3-opt-1024px-spacing=1"
LOCAL_DIR = "/hs/babbage/data/group-brueggen/tmartinez/diffusion/image_data_local/LOFAR/micromaps-arrow"
